    ...
    <section id="services" className="w-full py-24 container mx-auto px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {services.map((service, idx) => (
          ...
          >
            <div className="w-14 h-14 rounded-2xl bg-primary-500/10 flex items-center justify-center text-primary-500 mb-8 border border-white/5 group-hover:bg-primary-500 group-hover:text-white transition-all">
              {service.icon}
            </div>
