            ...
            {steps.map((step, idx) => (
              ...
              >
                ...
                <div className="flex-1 text-center md:text-left">
                   <div className={`glass-card p-10 relative overflow-hidden ${idx % 2 === 0 ? "md:text-left" : "md:text-right"}`}>
                      <span className="text-primary-500 font-black text-sm mb-4 block">{step.num}</span>
